...
import { User, CheckSquare, Users, Upload, Settings } from 'lucide-react';
    ...
    <div className="w-64 bg-brand-card border-r border-brand-border h-full flex flex-col transition-all duration-300">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="flex flex-col gap-3">
          <div
            className="bg-brand-card border border-brand-border rounded-lg p-3 flex items-center gap-3 cursor-grab hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500 transition-all active:cursor-grabbing group"
          ...
          <div
            className="bg-brand-card border border-brand-border rounded-lg p-3 flex items-center gap-3 cursor-grab hover:shadow-md hover:border-emerald-400 dark:hover:border-emerald-500 transition-all active:cursor-grabbing group"
          ...
          <div
            className="bg-brand-card border border-brand-border rounded-lg p-3 flex items-center gap-3 cursor-grab hover:shadow-md hover:border-violet-400 dark:hover:border-violet-500 transition-all active:cursor-grabbing group"
